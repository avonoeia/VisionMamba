...
def main(args):
    ...
    if args.model == "hybrid_mamba_efficientnet":
        model = models_hybrid.HybridMambaEfficientNet(num_classes=args.nb_classes)
    else:
        model = create_model(
            args.model,
            pretrained=False,
    ...
    if args.finetune:
        ...
        for k in ['mamba.head.weight', 'mamba.head.bias', 'mamba.head_dist.weight', 'mamba.head_dist.bias']:
